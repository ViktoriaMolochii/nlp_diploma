...
class LogisticRegressionModel:
    ...
    def train(self):
        ...
        features_df_train = self.features_creator.fit_and_save_features(train_corpus, self.features_creator, "data/features_train_ud.csv")
    ...
    def test(self):
        ...
        features_df_test = self.features_creator.fit_and_save_features(test_corpus, self.features_creator, "data/features_test_ud.csv")
